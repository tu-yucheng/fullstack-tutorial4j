...
public abstract class AbstractService {
	...
	/**
	 * The method returns the customer's address, but refreshes all the entries in the cache to load new ones.
	 *
	 * @param customer the customer
	 * @return the address
	 */
	...
	/**
	 * The method returns the customer's address, but not before selectively evicting the cache as per specified parameters.
	 *
	 * @param customer the customer
	 * @return the address
	 */
