 ...
 * (e.g. with the following command `docker run -p 3306:3306 --name tuyucheng-mysql -e MYSQL_ROOT_PASSWORD=pass -e MYSQL_DATABASE=jdbc_authentication mysql:latest`)
