 ...
 */
class FormAuthenticationLiveTest {
	...
	@Test
	void givenNoAuthentication_whenRequestSecuredResource_thenLoginFormResponse() {
		get(SVC_URL).then()
				.assertThat()
	...
	@Test
	void givenParsingFormAuthentication_whenRequestSecuredResource_thenLoginFormResponse() {
