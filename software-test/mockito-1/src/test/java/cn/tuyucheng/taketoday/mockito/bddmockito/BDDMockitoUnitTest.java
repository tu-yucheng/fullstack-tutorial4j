...
class BDDMockitoUnitTest {
	...
	@Test
	void givenInvalidContactName_whenSearch_thenReturnNull() {
	...
	@Test
	void givenValidContactNameAndPhoneNumber_whenRegister_thenSucceed() {
	...
	@Test
	void givenExistentContactName_whenRegister_thenFail() {
