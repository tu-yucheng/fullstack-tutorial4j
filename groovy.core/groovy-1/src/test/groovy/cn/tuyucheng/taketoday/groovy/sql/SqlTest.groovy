...
class SqlTest {
    ...
    void whenTableDoesNotExist_thenSelectFails() {
        try {
            Sql.withInstance(dbConnParams) { Sql sql ->
                sql.eachRows('select * from PROJECT') {}
            }
    ...
    void whenIdentityColumn_thenInsertReturnsNewId() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            ...
            def ids = sql.executeInsert("INSERT INTO PROJECT_2(NAME, URL) VALUES ('tutorial','github.com/tu-yucheng/fullstack-tutorial4j')")

            assertEquals(0, ids[0][0])

            ids = sql.executeInsert("INSERT INTO  PROJECT_2(NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/fullstack-tutorial4j')")
    ...
    void whenUpdate_thenNumberOfAffectedRows() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            ...
            sql.executeInsert("INSERT INTO PROJECT_3 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
            sql.executeInsert("INSERT INTO PROJECT_3 (NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/Rest-with-Spring')")
    ...
    void whenEachRow_thenResultSetHasProperties() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            ...
            sql.executeInsert("INSERT INTO PROJECT_4 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
            sql.executeInsert("INSERT INTO PROJECT_4 (NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/Rest-with-Spring')")
    ...
    void whenPagination_thenSubsetIsReturned() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            ...
            sql.executeInsert("INSERT INTO PROJECT_5 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
            sql.executeInsert("INSERT INTO PROJECT_5 (NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/Rest-with-Spring')")
    ...
    void whenParameters_thenReplacement() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            ...
            sql.execute('INSERT INTO PROJECT_6 (NAME, URL) VALUES (?, ?)', 'tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')
            sql.execute("INSERT INTO PROJECT_6 (NAME, URL) VALUES (:name, :url)", [name: 'REST with Spring', url: 'github.com/tu-yucheng/Rest-with-Spring'])
    ...
    void whenParametersInGString_thenReplacement() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            ...
            sql.execute "INSERT INTO PROJECT_7 (NAME, URL) VALUES (${'tutorials'}, ${'github.com/tu-yucheng/fullstack-tutorial4j'})"
            def name = 'REST with Spring'
            def url = 'github.com/tu-yucheng/Rest-with-Spring'
    ...
    void whenTransactionRollback_thenNoDataInserted() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            sql.withTransaction {
                ...
                sql.executeInsert("INSERT INTO PROJECT_8 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
                sql.executeInsert("INSERT INTO PROJECT_8 (NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/Rest-with-Spring')")
                sql.rollback()
    ...
    void whenTransactionRollbackThenCommit_thenOnlyLastInserted() {
        Sql.withInstance(dbConnParams) { Sql sql ->
            sql.withTransaction {
                ...
                sql.executeInsert("INSERT INTO PROJECT_9 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
                sql.rollback()
                sql.executeInsert("INSERT INTO PROJECT_9 (NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/Rest-with-Spring')")
                sql.rollback()
                sql.executeInsert("INSERT INTO PROJECT_9 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
                sql.executeInsert("INSERT INTO PROJECT_9 (NAME, URL) VALUES ('REST with Spring', 'github.com/tu-yucheng/Rest-with-Spring')")
            }
        ...
        Sql.withInstance(dbConnParams) { Sql sql ->
            try {
                sql.withTransaction {
                    ...
                    sql.executeInsert("INSERT INTO PROJECT_10 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
        ...
        Sql.withInstance(dbConnParams) { Sql sql ->
            try {
                sql.cacheConnection {
                    ...
                    sql.executeInsert("INSERT INTO PROJECT_11 (NAME, URL) VALUES ('tutorials', 'github.com/tu-yucheng/fullstack-tutorial4j')")
