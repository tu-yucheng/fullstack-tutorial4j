package cn.tuyucheng.boot.noconverterfound;

import cn.tuyucheng.boot.noconverterfound.controller.StudentRestController;
...
class NoConverterFoundIntegrationTest {
    ...
    void whenGettersNotDefined_thenThrowException() throws Exception {
        ...
        this.mockMvc.perform(get(url))
                ...
                .andExpect(result -> assertThat(result.getResolvedException().getMessage()).contains("No converter found for return value of type"));
    }
