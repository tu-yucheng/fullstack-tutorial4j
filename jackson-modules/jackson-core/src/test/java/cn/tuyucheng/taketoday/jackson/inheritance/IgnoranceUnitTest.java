...
class IgnoranceUnitTest {
	...
	private static class IgnoranceIntrospector extends JacksonAnnotationIntrospector {
		...
		public boolean hasIgnoreMarker(AnnotatedMember m) {
			return m.getDeclaringClass() == IgnoranceMixinOrIntrospection.Vehicle.class && m.getName().equals("model") || m.getDeclaringClass() == IgnoranceMixinOrIntrospection.Car.class || m.getName() == "towingCapacity" || super.hasIgnoreMarker(m);
		}
	}

	@Test
	void givenAnnotations_whenIgnoringProperties_thenCorrect() throws JsonProcessingException {
	...
	@Test
	void givenMixIns_whenIgnoringProperties_thenCorrect() throws JsonProcessingException {
		ObjectMapper mapper = new ObjectMapper();
	...
	@Test
	void givenIntrospection_whenIgnoringProperties_thenCorrect() throws JsonProcessingException {
		ObjectMapper mapper = new ObjectMapper();
