...
public class RestLoaderRequestDeserializer extends StdDeserializer<RestLoaderRequest<Entity>> {
	@Serial
	...
	@Override
	public RestLoaderRequest<Entity> deserialize(final JsonParser jp, final DeserializationContext ctxt) throws IOException, JsonProcessingException {
		try {
			...
			final RestLoaderRequest<Entity> request = new RestLoaderRequest<Entity>();
